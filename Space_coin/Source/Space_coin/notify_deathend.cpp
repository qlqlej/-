...
FString Unotify_deathend::GetNotifyName_Implementation() const
{
	return L"DeathEnd";
}

void Unotify_deathend::Notify(USkeletalMeshComponent* MeshComp, UAnimSequenceBase* Animation)
{
