...
#include "game_info.h"
#include "monster.h"
#include "first_water_monster.generated.h"

UCLASS()
class SPACE_COIN_API Afirst_water_monster : public Amonster
{
	GENERATED_BODY()

public:
	Afirst_water_monster();

protected:
	class Ufirst_water_monster_anim* first_water_monster_anim;
