...
#include "game_info.h"
#include "monster.h"
#include "second_water_monster.generated.h"
 
UCLASS()
class SPACE_COIN_API Asecond_water_monster : public Amonster
{
	GENERATED_BODY()

public:
	Asecond_water_monster();

protected:
	class Usecond_water_monster_anim* second_water_monster_anim;
