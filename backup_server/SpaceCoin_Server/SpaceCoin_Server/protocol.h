...
enum class OVER_TYPE { ACCEPT, RECV, SEND, PLAYER_MOVE};
enum class SESSION_STATE {FREE, WAIT, ACTIVE};
enum class PACKET_STATE {SUCCESS, SIGNUPFAIL, LOGINFAIL};
enum class MONSTER_TYPE { F_ICE, S_ICE, T_ICE, F_SAND, S_SAND, T_SAND, F_WATER, S_WATER, T_WATER, F_FISH };
enum class MAP_TYPE { SPACE, ICE, SAND, WATER, NOT_MAP };
enum class ATTACK_SKILL_TYPE { NORMAL, SNIPING, LAUNCHER, DASHING, MISSILE, ULTIMATE, DEFENSE, SLASH };
