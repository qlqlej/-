...
void SESSION::InitLogin(SC_LOGIN_INFO_PACKET& info_packet, CS_LOGIN_PACKET* login_packet)
{
	hp = info_packet.hp;
...
void SESSION::SendToAttackSkill(CS_ATTACK_SKILL_PACKET* packet)
{
...
void SESSION::SendToSpawnShip(CS_SPAWN_SPACESHIP_PACKET* packet)
{
